...
class Companydetails extends React.Component {
    ...
    validateCompanyinfo = () => {
        ...
        localStorage.setItem("YOE", this.state.YOE)
    ...
    render() { 
        ...
        return (<React-fragement>
            ...
            {
                this.state.verifyemail ? <Emailverifiaction Emailid={this.state.Emailid}></Emailverifiaction> :
